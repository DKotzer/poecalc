          ...
          <Card className='selectedCard'>
            <Card.Body>
              ...
              <ListGroup className='list-group-flush'>
                ...
                {activeItem.implicits[0] > 0 ? (
                  <ListGroup.Item>
                    {shortModsList[activeItem.implicits[0]].stats[0].id
                      ? shortModsList[activeItem.implicits[0]].stats[0].id
                          .replace(/_/g, " ")
                          .replace(/(?:^|\s|[-"'([{])+\S/g, (c) =>
                            c.toUpperCase()
                      ...
                      : ""}{" "}
                    {shortModsList[activeItem.implicits[0]].stats[0].min
                      ? shortModsList[activeItem.implicits[0]].stats[0].min
                      : ""}
                    -
                    {shortModsList[activeItem.implicits[0]].stats[0].max
                      ? shortModsList[activeItem.implicits[0]].stats[0].max
                      : ""}
                  </ListGroup.Item>
                ) : (
